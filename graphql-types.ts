...
export type Fauna = {
  ...
  findReviewByID?: Maybe<Fauna_Review>;
  /** Find a document from the collection of 'Product' by its id. */
  findProductByID?: Maybe<Fauna_Product>;
  allProducts: Fauna_ProductPage;
};


export type FaunaFindReviewByIdArgs = {
  id: Scalars['ID'];
};


export type FaunaFindProductByIdArgs = {
  id: Scalars['ID'];
};


export type FaunaAllProductsArgs = {
...
export type Fauna_Product = {
  image?: Maybe<Array<Maybe<Scalars['String']>>>;
  description?: Maybe<Scalars['String']>;
  /** The document's ID. */
  _id: Scalars['ID'];
  price: Scalars['Float'];
  reviews: Fauna_ReviewPage;
  title: Scalars['String'];
  /** The document's timestamp. */
  _ts: Scalars['Fauna_Long'];
};


export type Fauna_ProductReviewsArgs = {
  _size?: Maybe<Scalars['Int']>;
  _cursor?: Maybe<Scalars['String']>;
};

/** 'Product' input values */
export type Fauna_ProductInput = {
  title: Scalars['String'];
  description?: Maybe<Scalars['String']>;
  price: Scalars['Float'];
  image?: Maybe<Array<Maybe<Scalars['String']>>>;
  reviews?: Maybe<Fauna_ProductReviewsRelation>;
};

/** The pagination object for elements of type 'Product'. */
export type Fauna_ProductPage = {
  /** The elements of type 'Product' in this page. */
  data: Array<Maybe<Fauna_Product>>;
...
/** Allow manipulating the relationship between the types 'Product' and 'Review'. */
export type Fauna_ProductReviewsRelation = {
  /** Create one or more documents of type 'Review' and associate them with the current document. */
  create?: Maybe<Array<Maybe<Fauna_ReviewInput>>>;
  /** Connect one or more documents of type 'Review' with the current document using their IDs. */
  connect?: Maybe<Array<Maybe<Scalars['ID']>>>;
  /** Disconnect the given documents of type 'Review' from the current document using their IDs. */
  disconnect?: Maybe<Array<Maybe<Scalars['ID']>>>;
};

export type Fauna_Review = {
  stars: Scalars['Int'];
  username: Scalars['String'];
  /** The document's ID. */
  _id: Scalars['ID'];
  text: Scalars['String'];
  product: Fauna_Product;
  /** The document's timestamp. */
  _ts: Scalars['Fauna_Long'];
};

/** 'Review' input values */
export type Fauna_ReviewInput = {
  username: Scalars['String'];
  text: Scalars['String'];
  product?: Maybe<Fauna_ReviewProductRelation>;
  stars: Scalars['Int'];
};

/** The pagination object for elements of type 'Review'. */
export type Fauna_ReviewPage = {
  /** The elements of type 'Review' in this page. */
  data: Array<Maybe<Fauna_Review>>;
  /** A cursor for elements coming after the current page. */
  after?: Maybe<Scalars['String']>;
  /** A cursor for elements coming before the current page. */
  before?: Maybe<Scalars['String']>;
...
/** Allow manipulating the relationship between the types 'Review' and 'Product' using the field 'Review.product'. */
export type Fauna_ReviewProductRelation = {
  /** Create a document of type 'Product' and associate it with the current document. */
  create?: Maybe<Fauna_ProductInput>;
